...
int main() {
    ...
    auto instance = SMWTP("../instances_opt/instances/100/n100_54_b.txt");
    // auto instance = SMWTP("../instances/smwtp/n10_rdd0.4_tf1.0_seed2.txt");
    // instance.getFunction();
    // int globalMin = instance.globalMin;
    ...
    // auto info = DRILS(instance, 4, 1000000000000);
